...
def get_conversational_chain():
    ...
    If the answer is found in the context, write it clearly. Only include source references like [Source: filename.pdf, Page: X] at the end of your answer.

    If the answer is not found in the context, say:
    \"This answer was not found in the uploaded PDFs. However, here are some helpful web resources.\"
